...
{:else}
  <div class = "">
    ...
    <!-- O contêiner agora fica alinhado à esquerda (ml-0 mr-auto) e não centralizado -->
    <div class="w-full max-w-3xl ml-0 mr-auto my-8">
      <!-- Removidas as classes 'md:grid' e 'xl:hidden' para manter a lista vertical idêntica em qualquer monitor -->
      <div class="flex flex-col items-center gap-4">
        {#each users as user}
          <!-- Card de usuário idêntico ao das telas menores -->
